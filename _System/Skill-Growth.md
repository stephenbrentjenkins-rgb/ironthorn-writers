...
Reset boundary is the daily simulation tick (see [[Simulation-Tick]]). At the tick, all (NPC, check type) counters return to zero.
...
*[[README|Back to Index]] · [[Deception-Perception-Skills]] · [[Alignment-Spectrum]] · [[NPC-Intelligence-System]] · [[Attribute-Reference]] · [[Simulation-Tick]] · [[NPC-Tier-Reference]] · [[PoC-Scope]]*
